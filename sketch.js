...
var star2;
var star;
var starPoints,onestar,twostars,points;

function preload()
{
  bg_img = loadImage('2122cut.jpg');
...
function setup() 
{
  ...
  starPoints = createSprite(50,20,30,30);
  starPoints.addImage(points);
  starPoints.scale = 0.2;
...
function draw() 
{
  ...
  starPoints.addImage(onestar)
  onestar.visible=false;

   }

   if(collide(fruit,star2,20)){
    starPoints.addImage(twostar)
